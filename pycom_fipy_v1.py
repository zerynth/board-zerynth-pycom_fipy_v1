...
class PycomFiPy1(Board):

    @staticmethod
    def match(dev):
        return dev["vid"] in ("0403","04D8","04D8") and dev["pid"] in ("6015","F013","F012")
    ...
    def burn(self,bin,outfn=None):
        ...
        res,out,err = proc.runcmd("python",tools["esptool32"],"--chip", "esp32","--port",self.port,"--baud","1500000","--before", "no_reset", "--after", "no_reset","write_flash","-z","--flash_freq","40m","--flash_mode","dio","--flash_size","detect","0x1000",romf, "0x10000",iromf, "0x8000", bromf,"0x390000",vromf,outfn=outfn)
